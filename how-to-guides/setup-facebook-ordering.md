...
Choose "Page Tab". You will now need to fill in your store URL under "Secure Page Tab URL" and what you want to call your page tab under "Page Tab Name". Your store URL can either be your VestiPOS Order subdomain such as [https://yourdomain.order.vestipos.com](https://yourdomain.order.vestipos.com) or your custom domain name if setup
